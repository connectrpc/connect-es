...
async function extractBin(path) {
    if (path.endsWith(".zip")) {
        ...
        const binBytes = unzipped["connectconformance.exe"];
...
function getTempDir() {
    var _a;
    const tempDir = joinPath((_a = process.env["TEMP"]) !== null && _a !== void 0 ? _a : os.tmpdir(), "conformance");
