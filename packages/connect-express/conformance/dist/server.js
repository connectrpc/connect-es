...
export function run() {
    ...
    if (req.useTls && req.serverCreds !== undefined) {
        ...
        if (req.clientTlsCert.length > 0) {
            serverOptions = Object.assign(Object.assign({}, serverOptions), { requestCert: true, rejectUnauthorized: true, ca: Buffer.from(req.clientTlsCert) });
        }
    }
    ...
    server.listen(undefined, "127.0.0.1", () => {
        ...
        const res = new ServerCompatResponse({
            pemCert: serverOptions.cert !== undefined
