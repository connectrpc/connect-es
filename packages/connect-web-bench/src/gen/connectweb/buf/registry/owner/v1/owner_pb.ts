 ...
 */
export const file_buf_registry_owner_v1_owner: GenDescFile = /*@__PURE__*/
 ...
 */
export const OwnerSchema: GenDescMessage<Owner> = /*@__PURE__*/
 ...
 */
export const OwnerRefSchema: GenDescMessage<OwnerRef> = /*@__PURE__*/
