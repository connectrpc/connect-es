...
export class UploadRequest extends Message<UploadRequest> {
  ...
  static readonly typeName = "buf.registry.module.v1beta1.UploadRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "contents", kind: "message", T: UploadRequest_Content, repeated: true },
    { no: 2, name: "dep_refs", kind: "message", T: UploadRequest_DepRef, repeated: true },
  ]);
 ...
 */
export class UploadRequest_DepRef extends Message<UploadRequest_DepRef> {
  /**
  ...
  constructor(data?: PartialMessage<UploadRequest_DepRef>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "buf.registry.module.v1beta1.UploadRequest.DepRef";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "commit_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "registry", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): UploadRequest_DepRef {
    return new UploadRequest_DepRef().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): UploadRequest_DepRef {
    return new UploadRequest_DepRef().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): UploadRequest_DepRef {
    return new UploadRequest_DepRef().fromJsonString(jsonString, options);
  }

  static equals(a: UploadRequest_DepRef | PlainMessage<UploadRequest_DepRef> | undefined, b: UploadRequest_DepRef | PlainMessage<UploadRequest_DepRef> | undefined): boolean {
    return proto3.util.equals(UploadRequest_DepRef, a, b);
  }
}
...
export class UploadRequest_Content extends Message<UploadRequest_Content> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "buf.registry.module.v1beta1.UploadRequest.Content";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class UploadResponse extends Message<UploadResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "buf.registry.module.v1beta1.UploadResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
