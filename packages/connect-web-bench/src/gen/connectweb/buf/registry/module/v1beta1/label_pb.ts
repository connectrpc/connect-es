...
proto3.util.setEnumType(CommitCheckStatus, "buf.registry.module.v1beta1.CommitCheckStatus", [
...
export class Label extends Message<Label> {
  ...
  static readonly typeName = "buf.registry.module.v1beta1.Label";
...
export class CommitCheckState extends Message<CommitCheckState> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "buf.registry.module.v1beta1.CommitCheckState";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class LabelRef extends Message<LabelRef> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "buf.registry.module.v1beta1.LabelRef";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class LabelRef_Name extends Message<LabelRef_Name> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "buf.registry.module.v1beta1.LabelRef.Name";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class ScopedLabelRef extends Message<ScopedLabelRef> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "buf.registry.module.v1beta1.ScopedLabelRef";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */, oneof: "value" },
