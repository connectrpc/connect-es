...
export class Graph extends Message<Graph> {
  ...
  static readonly typeName = "buf.registry.module.v1.Graph";
...
export class Graph_Node extends Message<Graph_Node> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "buf.registry.module.v1.Graph.Node";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class Graph_Edge extends Message<Graph_Edge> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "buf.registry.module.v1.Graph.Edge";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
