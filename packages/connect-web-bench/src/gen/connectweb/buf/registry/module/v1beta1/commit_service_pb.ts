...
export class GetCommitsRequest extends Message<GetCommitsRequest> {
  ...
  static readonly typeName = "buf.registry.module.v1beta1.GetCommitsRequest";
...
export class GetCommitsResponse extends Message<GetCommitsResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "buf.registry.module.v1beta1.GetCommitsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class ListCommitsRequest extends Message<ListCommitsRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "buf.registry.module.v1beta1.ListCommitsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 6, name: "id_query", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
proto3.util.setEnumType(ListCommitsRequest_Order, "buf.registry.module.v1beta1.ListCommitsRequest.Order", [
...
export class ListCommitsResponse extends Message<ListCommitsResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "buf.registry.module.v1beta1.ListCommitsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
