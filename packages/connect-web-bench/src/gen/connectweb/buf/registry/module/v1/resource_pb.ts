...
export class Resource extends Message<Resource> {
  ...
  static readonly typeName = "buf.registry.module.v1.Resource";
...
export class ResourceRef extends Message<ResourceRef> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "buf.registry.module.v1.ResourceRef";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class ResourceRef_Name extends Message<ResourceRef_Name> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "buf.registry.module.v1.ResourceRef.Name";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
