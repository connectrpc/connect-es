...
export class GetModulesRequest extends jspb.Message {
  getModuleRefsList(): Array<buf_registry_module_v1beta1_module_pb.ModuleRef>;
  setModuleRefsList(value: Array<buf_registry_module_v1beta1_module_pb.ModuleRef>): GetModulesRequest;
  clearModuleRefsList(): GetModulesRequest;
  addModuleRefs(value?: buf_registry_module_v1beta1_module_pb.ModuleRef, index?: number): buf_registry_module_v1beta1_module_pb.ModuleRef;
...
export class GetModulesResponse extends jspb.Message {
  getModulesList(): Array<buf_registry_module_v1beta1_module_pb.Module>;
  setModulesList(value: Array<buf_registry_module_v1beta1_module_pb.Module>): GetModulesResponse;
  clearModulesList(): GetModulesResponse;
  addModules(value?: buf_registry_module_v1beta1_module_pb.Module, index?: number): buf_registry_module_v1beta1_module_pb.Module;
...
export class ListModulesResponse extends jspb.Message {
  ...
  getModulesList(): Array<buf_registry_module_v1beta1_module_pb.Module>;
  setModulesList(value: Array<buf_registry_module_v1beta1_module_pb.Module>): ListModulesResponse;
...
export namespace CreateModulesRequest {
  ...
  export class Value extends jspb.Message {
    ...
    getVisibility(): buf_registry_module_v1beta1_module_pb.ModuleVisibility;
    setVisibility(value: buf_registry_module_v1beta1_module_pb.ModuleVisibility): Value;
...
export class CreateModulesResponse extends jspb.Message {
  getModulesList(): Array<buf_registry_module_v1beta1_module_pb.Module>;
  setModulesList(value: Array<buf_registry_module_v1beta1_module_pb.Module>): CreateModulesResponse;
...
export namespace UpdateModulesRequest {
  ...
  export class Value extends jspb.Message {
    ...
    setModuleRef(value?: buf_registry_module_v1beta1_module_pb.ModuleRef): Value;
    ...
    getState(): buf_registry_module_v1beta1_module_pb.ModuleState;
    setState(value: buf_registry_module_v1beta1_module_pb.ModuleState): Value;
    hasState(): boolean;
    clearState(): Value;
...
export class UpdateModulesResponse extends jspb.Message {
  getModulesList(): Array<buf_registry_module_v1beta1_module_pb.Module>;
  setModulesList(value: Array<buf_registry_module_v1beta1_module_pb.Module>): UpdateModulesResponse;
...
export class DeleteModulesRequest extends jspb.Message {
  getModuleRefsList(): Array<buf_registry_module_v1beta1_module_pb.ModuleRef>;
  setModuleRefsList(value: Array<buf_registry_module_v1beta1_module_pb.ModuleRef>): DeleteModulesRequest;
