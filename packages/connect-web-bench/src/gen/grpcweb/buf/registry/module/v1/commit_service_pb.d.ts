...
export class GetCommitsRequest extends jspb.Message {
  ...
  setResourceRefsList(value: Array<buf_registry_module_v1_resource_pb.ResourceRef>): GetCommitsRequest;
...
export class GetCommitsResponse extends jspb.Message {
  ...
  setCommitsList(value: Array<buf_registry_module_v1_commit_pb.Commit>): GetCommitsResponse;
...
export class ListCommitsRequest extends jspb.Message {
  ...
  setResourceRef(value?: buf_registry_module_v1_resource_pb.ResourceRef): ListCommitsRequest;
...
export class ListCommitsResponse extends jspb.Message {
  ...
  getCommitsList(): Array<buf_registry_module_v1_commit_pb.Commit>;
  setCommitsList(value: Array<buf_registry_module_v1_commit_pb.Commit>): ListCommitsResponse;
