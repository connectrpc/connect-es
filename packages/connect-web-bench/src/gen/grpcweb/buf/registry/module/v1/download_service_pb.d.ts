...
export namespace DownloadRequest {
  ...
  export class Value extends jspb.Message {
    ...
    setResourceRef(value?: buf_registry_module_v1_resource_pb.ResourceRef): Value;
    hasResourceRef(): boolean;
    clearResourceRef(): Value;

    getFileTypesList(): Array<buf_registry_module_v1_file_pb.FileType>;
    setFileTypesList(value: Array<buf_registry_module_v1_file_pb.FileType>): Value;
    clearFileTypesList(): Value;
    addFileTypes(value: buf_registry_module_v1_file_pb.FileType, index?: number): Value;
...
export namespace DownloadResponse {
  ...
  export class Content extends jspb.Message {
    ...
    setCommit(value?: buf_registry_module_v1_commit_pb.Commit): Content;
    hasCommit(): boolean;
    clearCommit(): Content;
