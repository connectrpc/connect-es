...
export class Commit extends jspb.Message {
  ...
  getDigest(): buf_registry_module_v1beta1_digest_pb.Digest | undefined;
  setDigest(value?: buf_registry_module_v1beta1_digest_pb.Digest): Commit;
  hasDigest(): boolean;
  clearDigest(): Commit;
...
export namespace Commit {
  export type AsObject = {
    ...
    ownerId: string,
    moduleId: string,
    digest?: buf_registry_module_v1beta1_digest_pb.Digest.AsObject,
