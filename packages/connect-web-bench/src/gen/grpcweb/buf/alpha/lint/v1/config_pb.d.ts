...
export class Config extends jspb.Message {
  ...
  getEnumZeroValueSuffix(): string;
  setEnumZeroValueSuffix(value: string): Config;

  getRpcAllowSameRequestResponse(): boolean;
  setRpcAllowSameRequestResponse(value: boolean): Config;

  getRpcAllowGoogleProtobufEmptyRequests(): boolean;
  setRpcAllowGoogleProtobufEmptyRequests(value: boolean): Config;

  getRpcAllowGoogleProtobufEmptyResponses(): boolean;
  setRpcAllowGoogleProtobufEmptyResponses(value: boolean): Config;

  getServiceSuffix(): string;
  setServiceSuffix(value: string): Config;

  getAllowCommentIgnores(): boolean;
  setAllowCommentIgnores(value: boolean): Config;
