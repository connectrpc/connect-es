...
export class TestSuite extends Message<TestSuite> {
  ...
  /**
   * @generated from field: connectrpc.conformance.v1alpha1.TestSuite.TestMode mode = 2;
   */
  mode = TestSuite_TestMode.UNSPECIFIED;

  /**
   * @generated from field: repeated connectrpc.conformance.v1alpha1.TestCase test_cases = 3;
   */
  testCases: TestCase[] = [];
   ...
   *
   * @generated from field: repeated connectrpc.conformance.v1alpha1.Protocol relevant_protocols = 4;
   */
   ...
   *
   * @generated from field: repeated connectrpc.conformance.v1alpha1.HTTPVersion relevant_http_versions = 5;
   */
   ...
   *
   * @generated from field: repeated connectrpc.conformance.v1alpha1.Codec relevant_codecs = 6;
   */
   ...
   *
   * @generated from field: repeated connectrpc.conformance.v1alpha1.Compression relevant_compressions = 7;
   */
   ...
   * relies on.
   *
   * @generated from field: connectrpc.conformance.v1alpha1.TestSuite.ConnectVersionMode connect_version_mode = 8;
   */
...
/**
 * @generated from enum connectrpc.conformance.v1alpha1.TestSuite.TestMode
 */
...
proto3.util.setEnumType(TestSuite_TestMode, "connectrpc.conformance.v1alpha1.TestSuite.TestMode", [
...
/**
 * @generated from enum connectrpc.conformance.v1alpha1.TestSuite.ConnectVersionMode
 */
...
proto3.util.setEnumType(TestSuite_ConnectVersionMode, "connectrpc.conformance.v1alpha1.TestSuite.ConnectVersionMode", [
...
export class TestCase extends Message<TestCase> {
   ...
   *
   * @generated from field: repeated connectrpc.conformance.v1alpha1.TestCase.ExpandedSize expand_requests = 2;
   */
   ...
   *
   * @generated from field: connectrpc.conformance.v1alpha1.ClientResponseResult expected_response = 3;
   */
...
/**
 * @generated from message connectrpc.conformance.v1alpha1.TestCase.ExpandedSize
 */
export class TestCase_ExpandedSize extends Message<TestCase_ExpandedSize> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "connectrpc.conformance.v1alpha1.TestCase.ExpandedSize";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
