// This is copied from gRPC's testing Protobuf definitions: https://github.com/grpc/grpc/blob/master/src/proto/connectrpc/conformance/v1/test.proto
//
...
// UnimplementedStreamingOutputCall(connectrpc.conformance.v1.Empty) returns (stream connectrpc.conformance.v1.Empty): this RPC
...
// @generated by protoc-gen-connect-es v0.13.2 with parameter "ts_nocheck=false,target=ts"
