...
export type ClientCompatRequest = Message<"connectrpc.conformance.v1.ClientCompatRequest"> & {
   ...
   */
  clientTlsCreds?: TLSCreds | undefined;
   ...
   */
  cancel?: ClientCompatRequest_Cancel | undefined;
   ...
   */
  rawRequest?: RawHTTPRequest | undefined;
};
...
export type WireDetails = Message<"connectrpc.conformance.v1.WireDetails"> & {
   ...
   */
  connectErrorRaw?: JsonObject | undefined;
   ...
   */
  actualGrpcwebTrailers?: string | undefined;
};
